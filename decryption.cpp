...
int inverseSubNibble (int input)
{
    ...
    int finalOutput = 0;                                
    sscanf(inverseSboxOutputStr, "%x", &finalOutput);		//Here convert them to integer
...
int inverseMixColumn(int input) 
{
 ...
 char MixColmOutputStr[5];                          //S-Box outpus are hexadecimal values 
    ...
    int finalOutput = 0;                                 
    sscanf(MixColmOutputStr, "%x", &finalOutput);	//Here convert them to integer
